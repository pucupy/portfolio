...
Alejandro Velázquez · Lead / Staff product designer. Seven-page static portfolio site.
Exported 30 July 2026 for evaluation. Content only — visual system documented separately in `DESIGN-SYSTEM.md`.
...
`[image slot: Hosted Pages — bank selection, redesigned · 2200×920px]`
...
`[image slot: Console — redesigned dashboard or configurator · 2200×920px]`
...
`[image slot: Three design systems — components, tokens and templates · 2200×952px]`
...
`[image slot: Homepage directions, or Go Beyond identity · 2200×920px]`
...
`[image slot: Guidelines — a principle page with do/don't examples · 2200×840px]`
...
`[image slot: Demo library index, or a single journey with its request panel · 2200×840px]`
...
`[image slot: Enquiry Hub, or the funnel that justified it · 2200×840px]`
...
`[image slot: Operator dashboard, or the carer payment app · 2200×840px]`
...
`[image slot: NOMO — payout platform site and admin features · 2200×952px]`
...
`[image slot: Payfriendz — virtual Mastercard and App Store ranking · 2200×952px]`
...
`[image slot: Hosted Pages — the flow end to end · 2200×1120px]`
...
Four decisions below, and a pattern that runs through all of them.
...
`[image slot: Bank selection — before · 1080×840px]`

`[image slot: Bank selection — after, bottom sheet with brand grouping · 1080×840px]`
...
From there we prototyped three variants and tested them against both scenarios: an accordion, a dedicated results page, and a hybrid. The hybrid won — accordion behaviour for small result sets, a dedicated page once the list grows, and a filter that surfaces branches within a parent institution. It solves the two conditions with one component rather than branching into two designs the customer has to choose between.
...
`[image slot: Variant A — accordion · 700×760px]`

`[image slot: Variant B — dedicated results page · 700×760px]`
...
`[image slot: In-flow language selector · 1080×840px]`

`[image slot: Flow in a second language · 1080×840px]`
...
`[image slot: Recommended banks — recent and popular merged · 1080×840px]`
...
`[image slot: QR code screen — before · 1080×840px]`

`[image slot: QR code screen — after, with in-flow guidance · 1080×840px]`
...
`[image slot: Embedded login — trust signals and field mapping · 1080×840px]`
...
## Case study 02 — Console self-serve onboarding

`console.html`

### Turning a sales-led onboarding into a self-serve one

The Console is where Yapily customers sign up, manage applications, and configure their integration with the platform. Becoming a customer used to take six months to a year. This is the work to make most of that self-served — six years of a tool being built for one customer type, deprioritised, and then rebuilt for the customers it had never served.

`[image slot: Console — redesigned dashboard · 2200×1120px]`

#### How it got that way

**2020–2022 · One job, one customer type**

The Console began as a simple tool with one job: let a customer create an application and manage their registrations. It was built for customers holding their own licence and registrations, because at the time that was the only kind of customer there was. Yapily had five customers in 2020, Intuit among them, and at that size the scope was right.

It was also sales-led, and the value to the customer was thin. They couldn't see how their integration was actually performing — no API performance, nothing they could act on without asking us. Hosted Pages didn't exist yet as a concept, and neither did Yapily Connect, the model where agents operate under Yapily's licence rather than their own.

**2022 · A second customer type arrives**

The Console added Yapily Connect, and with it the ability for customers to manage their own bank portfolios — the institutions they connect to. Alongside it sat a simple guide with tutorials. That guide ended at a sales form, which is the detail worth noticing: self-service stopped one step short of being self-service.

**2022–2025 · Deprioritised**

What happened next wasn't a design failure, and it wasn't neglect either. The Console kept being iterated on — several team reshapes and technology migrations passed through it. What it never got was a re-scope. Each round improved the tool inside the shape it already had, because it was nobody's headline product and it kept more or less working, so the question of whether the shape was still right never made it onto anyone's roadmap.

So a tool scoped for five customers was still doing broadly the same job when there were two hundred. Every gap between what it did and what customers needed got absorbed by a person. CSMs, PMs and support staff manually enabled features, curated bank coverage on a customer's behalf, and communicated which banks supported what. None of that looked like a design problem. It just looked like we needed more people.

**2025 · Reprioritised**

The case was made again, this time with workshops and user research behind it, and with an operational burden the business could no longer absorb. The Console had stopped being a weak part of the product and become the bottleneck the rest of the company was routing around.

**2026 · Beta**

A new Console in beta, letting non-enterprise customers complete KYB online, manage their own bank portfolio, see performance and billing, invite their team, and configure integration tools like Hosted Pages — without a conversation with a person at any step.

Worth naming the pattern, because it repeats: like Hosted Pages, the Console was built for one licensing model and had to have the second one retrofitted into it. Both products were shaped by a customer type that didn't exist yet, and in both cases the cost showed up years later. The returning-user work is the third instance — one screen, two customer types wanting opposite behaviour from it — except that one we caught before building, which is the only reason it reads as a configuration decision rather than a rebuild.
...
*Caption: The journey as it was. Redrawn from the original map, with internal commercial detail removed.*
...
`[image slot: Hackathon output — the friction log, or the scoped initiatives · 2200×920px]`
...
*Caption: The journey the Console is designed to replace it with. Some steps are live in the beta and some are still to come.*
...
Customers complete know-your-business checks online and receive approvals through the product, replacing scheduled in-person compliance sessions. This is the step that most often stalled a go-live, and it stalled for scheduling reasons rather than substantive ones.
...
Conversion funnels, drop-off, bank performance, session data and billing, visible to the customer directly. Previously analytics were exported manually by CSMs and sent as reports, which cost us time and gave customers a stale picture. API performance had been invisible to customers since the first version of the Console in 2020.

`[image slot: Applications — credentials across sandbox and production · 1080×760px]`

*Caption: Applications and credentials*

`[image slot: Institutions — filter by market, product, payment type and rail · 1080×760px]`

*Caption: Institutions directory*

`[image slot: Analytics — funnels, drop-off, bank performance · 1080×760px]`

*Caption: In-product analytics*

`[image slot: Organisation — team members and scoped roles · 1080×760px]`

*Caption: Organisation and roles*
...
## Case study 03 — Three design systems
...
*Caption: Shared tokens were governed more tightly than components, and correctly so: a shared-token change lands on all three systems at once. Those changes required approval from both the frontend lead and the design lead, and in practice happened rarely — effectively only during rebrand work.*
...
## Case study 04 — Research practice
...
Hosted Pages converted at around 20% in the 2023 beta. End to end today it runs at roughly 65–75%, varying by use case, country and other dimensions. That gain was made incrementally, over three years, by UX, frontend and backend working the same problem from different sides — not by one redesign. In open banking a meaningful share of end-to-end conversion is infrastructure — bank API reliability, redirect success, coverage. Design was one of the three disciplines that moved it, and the experiments above are part of how.
...
`[image: Cuvva out-of-home advert at Oxford Circus]`

*Caption: Out-of-home campaign, Oxford Circus*

`[image: Cuvva logo applied to a t-shirt]`

*Caption: Identity applied to merchandise*

`[image: Four Cuvva app coverage states side by side]`

*Caption: Coverage states — parked, driving, paying*

`[image: Animated Cuvva coverage screen]`

*Caption: Coverage screen, animated*

#### Payfriendz

`[image: Payfriendz group collection inside a chat]`

*Caption: Group collection inside a chat*

`[image: Payfriendz profile with badges and card activation]`

*Caption: Profile, badges and card activation*

`[image: Payfriendz maintenance screen]`

*Caption: Maintenance screen — reassurance about money*

#### Illustration and marks

`[image: Collection of vector character portraits]`

*Caption: Vector character portraits*
...
*Caption: Mascot mark, flat construction*
...
*Caption: Tesla, printed*

`[image: Darwin shirt worn]`

*Caption: Darwin, printed*

`[image: Rosalind Franklin shirt worn]`

*Caption: Rosalind, printed*

`[image: Ada Lovelace shirt worn]`

*Caption: Lovelace, printed*
...
*Caption: Product strips — Payfriendz and Monzo*

`[image: Illustrated account-manager journey map]`

*Caption: Illustrated account-manager journey, HeadBox*

`[image: Three-panel freeze-card storyboard]`

*Caption: Freeze-card storyboard*

`[image: Payfriendz promotional five-pound note]`

*Caption: Promotional fiver — Payfriendz*
