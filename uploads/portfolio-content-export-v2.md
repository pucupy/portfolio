...
Ale Velazquez portfolio. Exported 2026-07-30, revised 2026-07-30 (v2).
Revisions: research-practice.html closing line; index.html item 09 (Caremoni) outcome claim; register pass across all pages.
All figures, dates, caveats and attributions unchanged from the original export.
...
I try to run things in the open. I ran a hackathon where the team spent a week role-playing as an outside consultancy, using only what a real customer can access — no internal shortcuts. It surfaced more about our onboarding experience in five days than a quarter of internal review had.
