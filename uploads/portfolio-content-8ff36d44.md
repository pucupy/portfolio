...
Pages from the library documentation — tokens, anatomy, states and spacing. Every component was documented this way so a decision only had to be made once.

- `[image: Typography documentation — family, root tokens and the full style scale]` · TOKENS
- `[image: Colour documentation — brand, text and neutral ramps with usage rules]` · TOKENS
- `[image: Customer logo — size bounds and placement at both resolutions]` · BRANDING
- `[image: Bank list row anatomy — parts, dependencies and what each one inherits]` · ANATOMY
- `[image: Text inputs — guidance, variants, anatomy and spacing]` · COMPONENT
- `[image: Search — five states across three widths]` · COMPONENT
- `[image: Checkboxes and radios — every state, with and without helper text]` · COMPONENT
- `[image: Button footer — twelve variants of consent copy, device and region]` · COMPONENT
- `[image: Notifications — inline errors, documented in context]` · COMPONENT
- `[image: Toasts — success, information, warning and error, plus placement]` · COMPONENT
