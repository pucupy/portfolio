...
Worth naming the pattern, because it repeats: like Hosted Pages, the Console was built for one licensing model and had to have the second one retrofitted into it. Both products were shaped by a customer type that didn't exist yet, and in both cases the cost showed up years later.
