...
Ale Velazquez portfolio. Exported 2026-07-30 (v4 — accuracy pass after interview-presentation work).
...
**`index.html`**
- "around 1,000 usability tests" → "around 1,000 end-user usability sessions"
- Console entry: "previously a support ticket" → "previously a support ticket and an engineer, per request"
- Research practice entry: "the thousand-odd consumers who tested" → "the thousand-odd sessions with consumers who tested"
...
- "put the flow in front of roughly a thousand ordinary people" → "ran around a thousand sessions with ordinary people"
...
- Leadership: "the 2023–2025 programme" → "the 2023–2026 programme"
...
- Accessibility validation: added the postponed release
- Outcomes: added design's specific contribution to conversion
- Stat tile: "~1,000 usability tests behind the redesign" → "~1,000 usability sessions behind the redesign"

**`console.html`**
- Added the VP of Platform resistance and what changed it
...
I led strategy and design at launch and have owned the product since, including a 2023–2026 research programme of around 1,000 end-user usability sessions, the prototype and accessibility studies that followed, and the resulting roadmap.
Full case study →
02 Yapily Console
...
Two audiences needed two methods: the businesses integrating with us, and the thousand-odd sessions with consumers who tested the bank-connection flow between 2023 and 2026. Around that sat a bi-weekly feedback forum with Support, CS, product and engineering, a jointly prioritised board, beta programmes with 150 customers, event instrumentation built with engineering, and an in-house experimentation pipeline testing variants against production traffic.
...
Set the research and product design direction for the 2023–2026 programme that took Hosted Pages from MVP to general availability, including the usability programme and the follow-up prototype and accessibility studies. Led the June 2026 cross-functional workshop with frontend and design teams to scope the next roadmap. Worked with designers and product managers at Google over two years as they built their own open banking products on Yapily. Supported Yapily's compliance team in preparing presentations to the FCA.
...
The main resistance came from our VP of Platform, and the objection was a fair one. The priority was launching integrations in more regions — the growth engine, and what customers asked for in sales conversations. Console work would take capacity away from it. That was a concrete bet against a vaguer one.
...
1. **"Around 1,000 usability sessions"** — confirm whether this is participants, sessions, or an order-of-magnitude estimate. At ten to fifteen participants per study it implies seventy to a hundred studies across three years. v4 uses "sessions" consistently; change if that's wrong.
