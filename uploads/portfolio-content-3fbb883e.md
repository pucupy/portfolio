...
FOUNDING DESIGNER — Built Yapily's design function from the first hire.
CONTINUOUS RESEARCH — 200+ customer interviews since 2020, plus end-user testing.
REGULATED PRODUCTS — Open banking, payments, compliance, enterprise SaaS.
HANDS-ON — Strategy, research, interaction design, systems, prototypes, code.
2020 — PRESENT
...
#### Yapily Hosted Pages
2022 — present · Generally available since late 2025; optimisation ongoing
...
### At a glance
Role: Product strategy, research and design lead · Period: 2022 to present · Working with: product, frontend, backend, compliance, implementation
Status: Generally available since late 2025; optimisation ongoing
Outcome: Integration from four to six months down to around two weeks · bank discovery from 5–15 seconds to 1–3 in most markets
...
### At a glance
Role: Product strategy and design lead · Period: 2020 to present · Working with: product, engineering, support, customer success, implementation
Status: Hosted Pages configurator shipped; new Console in beta
Outcome: Assisted onboarding for enterprise, self-service for everyone else · configuration moved from support tickets to the customer
...
### At a glance
Role: Design system strategy, architecture and governance · Period: 2020 to present · Working with: design, frontend
Status: Shipped and in use
Outcome: Around 38 engineers and 4 designers building against them · accessibility encoded in the token layer · governance built jointly with the frontend lead
